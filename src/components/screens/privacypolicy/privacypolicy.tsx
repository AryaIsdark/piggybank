  ...
  return (
    <>
      <div style={{ padding: "100px 30px" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to peegie.
            </p>
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to peegie, accessible from
            https://peegie.netlify.com
          </li>
          <li>
        ...
        <ul>
          <li>By email: shahali.arya@gmail.com</li>
        </ul>
      </div>
    </>
  );
